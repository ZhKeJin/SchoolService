...
public class WeatherRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_BASIC) {
            BasicViewHolder viewHolder = new BasicViewHolder(LayoutInflater.from(context).inflate(R.layout.item_info_basic, parent, false));
            LogUtils.e("onCreateViewHolder: 001");

            return viewHolder;
        } else {
            TempViewHolder holder = new TempViewHolder(LayoutInflater.from(context).inflate(R.layout.item_info_temp, parent, false));
            return holder;
        }
    }
